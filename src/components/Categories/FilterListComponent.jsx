  ...
  function ChangeFilter(item) {
    ...
    if (item.brand != null) {
      if (param.get('brand') == null || param.get('brand') == '')
        ...
        param.set('brand', param.get('brand').includes(item.brand) ? param.get('brand').replace(item.brand, '-').replace(',-', '').replace('-', '')
      ...
      if (param.get('color') == null || param.get('color') == '')
        ...
        param.set('color', param.get('color').includes(item.colorNameEn) ? param.get('color').replace(item.colorNameEn, '-').replace(',-', '').replace('-', '')
